...
export const fruitInfo = {
  Orange: {
    ...
    description: `
      Most people will be very familiar with this bright and tangy fruit.
      ...
      Some appear far more delicious than they are in reality!
    `,
    usage: `
      Eat fresh off the tree, press for fresh and delicious orange juice,
  ...
  Loquat: {
    ...
    description: `
      ...
      also tasty if you prefer more tartness.
    `,
    usage: `
      Eat fresh off the tree, juice them, or bake into pies, tarts,
  ...
  Fig: {
    ...
    description: `
      A close contender for the best plant of all at Stanford, the fig is a 
      ...
      with almond notes, although I have yet to try this.
    `,
    usage: `
      Eat fresh, dry them for later, dry leaves for tea, or use fruits in 
  ...
  "Brush Cherry": {
    ...
    `,
    usage: `
      Eat fresh off the tree, use in desserts, or make into jams and jellies.
    `
    },
    "Avocado": {
    ...
    description: `
      I knew of the presence of avocados at Stanford since year one, but I 
      ...
      an all-around superfood!
      `,
    usage: `
    Eat alone or on avocado toast, try a rich avocado smoothie, make guacamole, 
  ...
  `
    ...
    description: `
      There are a few Hachiyas on campus, most notably the large and stately 
      ...
      is almost spreadable like jelly. 
    `,
    usage: `
      Enjoy fresh once completely ripe either on its own or added to yogurt or oatmeal,
  ...
  "Fuyu Persimmon": {
    ...
    months: ['november'],
    description: `
      Fuyu persimmons are a popular variety known for their sweet, crisp flesh and
      ...
      if the birds haven't gotten to them first!
    `,
    usage: `
      Enjoy fresh, dried, or in baked goods. They also make a lovely topping for salads and 
      yogurt bowls.
    `
  },
  Pomegranate: {
    ...
    description: `
    The pomegranates growing on campus are some sort of ornamental, and as a result
    ...
    blazingly scarlet flowers.
    `,
    usage: `
    Eat the arils fresh, sprinkle them on salads or yogurt, juice them, or use
...
Apple: {
    ...
    you might find something delicious.
    `,
    usage: `
    Eat fresh, bake into pies or crisps, make applesauce or apple butter, juice them, 
 ...
 Feijoa: {
    ...
    months: ['october', 'november'],
    description: `
      Also known as pineapple guava, feijoas are a unique fruit with a sweet, aromatic 
      ...
      a bit gritty, so scooping out the tasty inner flesh is recommended.
      `,
    usage: `
    Eat fresh, use in smoothies, or incorporate into desserts. The spongy flower petals are also
 ...
 "Natal Plum": {
    ...
    description: `
      ...
      consuming the fruit, but otherwise, they are a delightful treat.
    `,
    usage: `
